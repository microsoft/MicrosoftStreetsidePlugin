 ...
 *
 */
public final class StreetsideFilterChooseSigns extends JPanel {

  private static final long serialVersionUID = -4858656447066921229L;
  ...
  private static StreetsideFilterChooseSigns instance;

  private StreetsideFilterChooseSigns() {
    // i18n: traffic sign
   ...
   * @return the unique instance of the class.
   */
  public static synchronized StreetsideFilterChooseSigns getInstance() {
    if (instance == null) {
      instance = new StreetsideFilterChooseSigns();
    }
    return instance;
  }
}
