...
public class ImageImportUtilTest {
  ...
  public void testUntaggedImage() throws URISyntaxException, IOException {
    ...
    List<StreetsideImportedImage> images = ImageImportUtil.readImagesFrom(untaggedFile, defaultLL);
    assertEquals(1, images.size());
    assertEquals(0, images.get(0).getMovingHe(), 1e-9);
    ...
    assertTrue(images.get(0).getHe() >= startTime && images.get(0).getHe() <= endTime);
  }
  ...
  public void testGpsDirectionOnlyImage() throws URISyntaxException, IOException {
    ...
    List<StreetsideImportedImage> images = ImageImportUtil.readImagesFrom(untaggedFile, defaultLL);
    assertEquals(1, images.size());
    assertEquals(42.73, images.get(0).getMovingHe(), 1e-9);
    assertEquals(defaultLL, images.get(0).getMovingLatLon());
    assertEquals(untaggedFile, images.get(0).getFile());
    long endTime = System.currentTimeMillis() / 1000 * 1000 + 1000; // Rounding to next full second
    assertTrue(images.get(0).getHe() >= startTime && images.get(0).getHe() <= endTime);
  ...
  public void testDateTimeOnlyImage() throws URISyntaxException, IOException {
    ...
    assertEquals(1_450_918_923_000L /*2015-12-24 01:02:03+0000*/, images.get(0).getHe());
    ...
    assertEquals(1_450_908_123_000L /*2015-12-24 01:02:03+0300*/, images.get(0).getHe());
  }
  ...
  public void testImageDirectory() throws URISyntaxException, IOException {
    ...
    List<StreetsideImportedImage> images = ImageImportUtil.readImagesFrom(imageDirectory, new LatLon(42,-73));
